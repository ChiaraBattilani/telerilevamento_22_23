...
plot(l2011$B1_sre) # plotto il nome dell'oggetto
# or
plot(l2011[[1]]) #plotto l'elemento numero 1
...
# plot b1 from dark green to green to light green
...
plot(l2011$B1_sre, col=clb)
plot(l2011$B2_sre, col=clg)
dev.off() #mettilo solo se devi chiuderle se no continua a fare finestre a 2 img
